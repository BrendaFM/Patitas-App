...
<p class="display-6 m-3" style="text-align:center">Información del Albergue</p>
<br>
<div class="container">
    <div class="row">
        <div class="card col-md-4 mr-5">
        <img src="./img/patitas.jpg" class="card-img-top" alt="...">
        </div>
        ...
        <div class="col-md-7" style="text-align:justify">
            ...
            <p style="font-size:20px" class="text-end fst-italic">~ Patitas App</p>
        </div>
    </div>
    <br>
    <hr>
    ...
    <div class="row">
            ...
            <div class="card col-md-3 ">
                <div class="card-body">
                    <img src="./img/BCP.png" class="card-img-top" alt="...">
            ...
            <div class="card col-md-3 ">
                <div class="card-body">
                    <img src="./img/icono-yape-plin.jpg" class="card-img-top" alt="...">
                    <div style='text-align:center; font-size:20px'>
            ...
            <div class="card col-md-3 ">
                <div class="card-body">
                    <img src="./img/interbank" class="card-img-top" alt="...">
                    <div style='text-align:center; font-size:20px'>
            ...
            <div class="card col-md-3 ">
                <div class="card-body">
                    <img src="./img/scotiabank_web.png" class="card-img-top" alt="...">
                    <div style='text-align:center; font-size:20px'>
        ...
        <div class="card col-md-5 m-5">
            <div class="card-body">
                ...
                <h5 class="card-title" style="text-align:center">¿Quieres ser colaborador?</h5>
                    ...
                    <p style="text-align:center; font-size:19px" class="text-end fst-italic">"La lealtad de un animal no conoce límites"</p>
                </div>
            </div>
        </div>
        ...
        <div class="card col-md-5 m-5">
            <div class="card-body">
                ...
                <h5 class="card-title" style="text-align:center">¿Quieres ser Padrino?</h5>
                    ...
                    <p style="text-align:center; font-size:19px" class="text-end fst-italic">"Hasta que no hayas amado a un animal, una parte de tu alma permanecera dormida"</p>
                </div>
            </div>
        </div>
